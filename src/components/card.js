...
const cardAppender = (selector) => {
  ...
  .then((e) => {
    const array = Object.keys(e.data.articles)
    card.append(Card(array))
    array.forEach((array) => {
      e.data.articles[array].forEach((final) => {
        document.querySelector(selector).append(Card(final));
      });
    });
  });
};
